...
/** 
 * Controlador logico de la biblioteca, con los metodos necesarios para guardar y pasar información al drier program
 * @author Ricardo Chuy
 */
public class Library_Admin {
	...
	/**
	 * @param _clientList Lista de cliente activos
